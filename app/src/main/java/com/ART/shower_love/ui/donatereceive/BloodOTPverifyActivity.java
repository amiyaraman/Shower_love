...
public class BloodOTPverifyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.blood_verify_layout);

        mOtpText = findViewById(R.id.blood_verificattion_code_et);
        mVerifybtn = findViewById(R.id.blood_Button_otp);
        verifyProgressBar = findViewById(R.id.blood_otp_progress_bar);
        mAuth = FirebaseAuth.getInstance();
        mCurrentUser = mAuth.getCurrentUser();

        mAuthVerificationId = getIntent().getStringExtra("AuthCredentials");
        UserGender = getIntent().getStringExtra("Gender");
        itemChatogory = getIntent().getStringExtra("Blood Group");
    ...
    private void signInWithOhoneAuthCredential(PhoneAuthCredential credential) {
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(com.ART.shower_love.ui.donatereceive.BloodOTPverifyActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
    ...
    private void senduserHome() {
        Intent HomeiNtent = new Intent(com.ART.shower_love.ui.donatereceive.BloodOTPverifyActivity.this, BloodDonatePage.class);
        HomeiNtent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        HomeiNtent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
        HomeiNtent.putExtra("Blood Group", itemChatogory);
